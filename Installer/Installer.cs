...
namespace Installer
{
    ...
    public partial class Installer : System.Configuration.Install.Installer
    {
        ...
        static string CFGFOLDER_PATH = Path.Combine(APPDATA_PATH, "BBI ExportTablaAreas");
        static string CFGFILE_NAME = "ExportTablaAreas.config";
        ...
        private void WriteRevitAddin()
        {
            foreach (var product in RevitProductUtility.GetAllInstalledRevitProducts())
            {
                ...
                {
                    string pathAddin = product.AllUsersAddInFolder + "\\ExportTablaAreas.addin";
                    Guid guid = new Guid("4ce6f415-8380-4c39-a178-03fd13ad3145");
                    ...
                    if (app == null)
                    {
                        app = new RevitAddInApplication("ExportTablaAreas", assembly, guid, fullClassName, vendorId);
        ...
        private string GetAssembly()
        {
            ...
            return pathDir + "ExportTablaAreas.dll";
        }
    }
}
